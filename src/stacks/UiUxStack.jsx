    ...
    const fetchResources = async () => {
      try {
        ...
        const mappedVideos = (videos || []).map((video, idx) => ({
          ...video,
          image: video.thumbnail_url || [videoimg1, videoimg2, videoimg1][idx % 3] || videoimg1,
          duration: video.duration || 'N/A'
        }));

        const mappedPdfs = (pdfs || []).map((pdf, idx) => ({
          ...pdf,
          image: pdf.thumbnail_url || [pdfimage1, pdfimage2][idx % 2] || pdfimage1
        }));
