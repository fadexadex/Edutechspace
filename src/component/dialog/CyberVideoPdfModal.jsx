...
const CyberVideoPdfModal = ({ type, onClose }) => {
  ...
  const courseType = "Cybersecurity"; // This is fixed for this component
      ...
      return [
        {
          ...
          requirement: "No prior knowledge required – just curiosity and a willingness to learn."
        },
        {
          id: 2,
          ...
          requirement: "Watch 'Introduction to Cybersecurity' first."
        }
      ];
    } else {
      return [
        ...
        },
        {
          ...
          resource_url: "https://nvlpubs.nist.gov/nistpubs/SpecialPublications/NIST.SP.800-53r5.pdf",
          description: "The official NIST framework for improving critical infrastructure cybersecurity."
        }
      ];
    }
  };
...
export default CyberVideoPdfModal;